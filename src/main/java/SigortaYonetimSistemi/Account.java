...
public abstract class Account {
    ...
    public final void showUserInfo() {
        ...
        for(int i = 0; i< user.getAddressList().size() ; i++) {
            ...
            System.out.print(user.getAddressList().get(i).getStreet() + ", "+user.getAddressList().get(i).getTown()+", "+user.getAddressList().get(i).getCity()+ ", "+user.getAddressList().get(i).getCountry()+"\n");
        }
